...
const saveKey = 'prize-stock-alert.saved'
const postKey = 'prize-stock-alert.posts'
const items = [
  {
    "id": "prize-stock-alert-1",
    "title": "名古屋 フィギュア seed",
    "area": "名古屋",
    "category": "フィギュア",
    "score": 94,
    "summary": "キャラクター名、景品名、店舗名からプライズ入荷、在庫、取れやすさ、再入荷通知を探せるUGC型在庫アラート。 初期データとして、検索意図、UGC、送客導線を同じ画面で確認できるようにしています。",
    "tags": [
      "フィギュア",
      "名古屋",
      "UGC",
  ...
  {
    "id": "prize-stock-alert-4",
    "title": "静岡 ゲームセンター seed",
    "area": "静岡",
    "category": "ゲームセンター",
    "score": 82,
    "summary": "キャラクター名、景品名、店舗名からプライズ入荷、在庫、取れやすさ、再入荷通知を探せるUGC型在庫アラート。 初期データとして、検索意図、UGC、送客導線を同じ画面で確認できるようにしています。",
...
const faqs = [
  ['誰向けのサービスですか？', 'プライズ・ゲームセンター在庫情報に関心があり、検索後すぐに行動したいユーザー向けです。'],
  ['主な収益化は何ですか？', '入荷通知課金、店舗掲載課金、ECアフィリエイト、景品スポンサー、動画連携広告を初期導線にします。'],
...
function App() {
  ...
  const [form, setForm] = useState({ title: '', target: 'フィギュア', memo: '' })
  ...
  function addPost(event) {
    ...
    setForm({ title: '', target: 'フィギュア', memo: '' })
  }
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">プライズ・ゲームセンター在庫情報</p>
          <h1>Prize Stock Alert</h1>
          <p className="lead">キャラクター名、景品名、店舗名からプライズ入荷、在庫、取れやすさ、再入荷通知を探せるUGC型在庫アラート。</p>
        </div>
        <aside className="hero-panel">
          <span>prizealert.jp / prize-stock-alert</span>
